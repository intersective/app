...
describe('SettingsEmbedComponent', () => {
  let component: SettingsEmbedComponent;
  let fixture: ComponentFixture<SettingsEmbedComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ SettingsEmbedComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(SettingsEmbedComponent);
