...
describe('AppV2', () => {
  ...
  xit('should login and select a program', () => {
  ...
  xit('should able to select first program', () => {
  ...
  xit('should display Page Not Found if page is non-existence', () => {
  ...
  xit('should be able to browse to different Home/Activities/Chat/Settings tab', () => {
  ...
  xit('should display proper info in setting page', () => {
  ...
  xit('should be able to go select program screen from settings page', () => {
  ...
  xit('should able to browse between sub-pages inside project module', () => {
  ...
  xit('should able to browse between sub-pages inside chat module', () => {
  ...
  xit('should not display program switcher page for user enrolled to only one program', () => {
    browser.executeScript('window.localStorage.clear();');
    page.navigateTo('/');
    browser.sleep(3000);
  ...
  xit('should show mentor tab menu normally and has one assessment to review', () => {
    browser.executeScript('window.localStorage.clear();');
    page.navigateTo('/');
    browser.sleep(3000);
    browser.waitForAngularEnabled().then(res => {
  ...
  // xit('should be able to submit assessment', () => {});
});
