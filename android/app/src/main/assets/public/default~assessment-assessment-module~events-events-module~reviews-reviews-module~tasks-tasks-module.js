...
var AssessmentComponent = /** @class */ (function (_super) {
    ...
    AssessmentComponent.prototype.onEnter = function () {
        ...
        this.assessmentService.getAssessment(this.id, this.action, this.activityId, this.contextId, this.submissionId)
            ...
            _this.assessment = result.assessment;
            ...
            _this._handleSubmissionData(result.submission);
            ...
            _this._handleReviewData(result.review);
        }, function (error) {
            _this.newRelic.noticeError(error);
        });
    };
    AssessmentComponent.prototype._handleSubmissionData = function (submission) {
    ...
    AssessmentComponent.prototype._handleReviewData = function (review) {
        var _this = this;
        this.review = review;
    ...
    AssessmentComponent.prototype.clickBtnContinue = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.submission && this.submission.status === 'published' && !this.feedbackReviewed)) return [3 /*break*/, 2];
    ...
    AssessmentComponent.prototype.submit = function (saveInProgress, goBack, isManualSave) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.assessmentService.saveAnswers(assessment, answers, this.action, this.submission ? this.submission.id : 0).subscribe(function (result) {
                    if (saveInProgress) {
...
var AssessmentService = /** @class */ (function () {
    ...
    AssessmentService.prototype.getAssessment = function (id, action, activityId, contextId, submissionId) {
        var _this = this;
        return this.request.postGraphQL(this.utils.graphQLQueryStringFormatter("\"{\n          assessment(id:" + id + ",reviewer:" + (action === 'review') + ",activityId:" + activityId + ") {\n            name type description dueDate isTeam pulseCheck\n            groups{\n              name description\n              questions{\n                id name description type isRequired hasComment audience fileType\n                choices{\n                  id name explanation description\n                }\n                teamMembers{\n                  userId userName teamId\n                }\n              }\n            }\n            submissions(" + (submissionId ? "id:" + submissionId : "contextId:" + contextId) + ") {\n              id status completed modified locked\n              submitter {\n                name image\n              }\n              answers{\n                questionId answer\n              }\n              review {\n                id status modified\n                reviewer { name }\n                answers {\n                  questionId answer comment\n                }\n              }\n            }\n          }\n        }\""))
            ...
            return {
                assessment: _this._normaliseAssessment(res.data, action),
                submission: _this._normaliseSubmission(res.data),
                review: _this._normaliseReview(res.data, action)
            };
        }));
    };
    AssessmentService.prototype._normaliseAssessment = function (data, action) {
        var _this = this;
        if (!data.assessment) {
            return null;
        }
        ...
        data.assessment.groups.forEach(function (eachGroup) {
            var questions = [];
            if (!eachGroup.questions) {
                return;
            }
            eachGroup.questions.forEach(function (eachQuestion) {
                _this.questions[eachQuestion.id] = eachQuestion;
                var question = {
                    id: eachQuestion.id,
                ...
                switch (eachQuestion.type) {
                    ...
                    case 'multiple':
                        var choices_1 = [];
                        var info_1 = '';
                        eachQuestion.choices.forEach(function (eachChoice) {
                            choices_1.push({
                                id: eachChoice.id,
                            ...
                            if (eachChoice.description) {
                                info_1 += '<p>' + eachChoice.name + ' - ' + eachChoice.description + '</p>';
                            }
                        });
                        if (info_1) {
                            // add the title
                        ...
                        question.info = info_1;
                        question.choices = choices_1;
                        break;
                    case 'file':
                    ...
                    case 'team member selector':
                        ...
                        eachQuestion.teamMembers.forEach(function (eachTeamMember) {
    ...
    AssessmentService.prototype._normaliseSubmission = function (data) {
        var _this = this;
        if (!this.utils.has(data, 'assessment.submissions') || data.assessment.submissions.length < 1) {
            return null;
        }
        var firstSubmission = data.assessment.submissions[0];
        var submission = {
        ...
        firstSubmission.answers.forEach(function (eachAnswer) {
            eachAnswer.answer = _this._normaliseAnswer(eachAnswer.questionId, eachAnswer.answer);
            submission.answers[eachAnswer.questionId] = {
                answer: eachAnswer.answer
            };
            if (['published', 'done'].includes(submission.status)) {
                submission = _this._addChoiceExplanation(eachAnswer, submission);
            }
        });
        return submission;
    };
    AssessmentService.prototype._normaliseReview = function (data, action) {
        var _this = this;
        if (!this.utils.has(data, 'assessment.submissions') || data.assessment.submissions.length < 1) {
            return null;
        }
        var firstSubmission = data.assessment.submissions[0];
        var firstSubmissionReview = firstSubmission.review;
        ...
        firstSubmissionReview.answers.forEach(function (eachAnswer) {
            eachAnswer.answer = _this._normaliseAnswer(eachAnswer.questionId, eachAnswer.answer);
    ...
    AssessmentService.prototype._addChoiceExplanation = function (submissionAnswer, submission) {
        ...
        if (Array.isArray(answer)) {
            // multiple question
            this.questions[questionId].choices.forEach(function (choice) {
...
var FileDisplayComponent = /** @class */ (function () {
    ...
    FileDisplayComponent.prototype._resetUILogic = function () {
        this.virusDetection = {};
        this.quarantine = {};
        if (this.videoEle) {
    ...
    FileDisplayComponent.prototype.removeUploadedFile = function () {
    ...
    ], FileDisplayComponent.prototype, "isFileComponent", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('videoEle'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], FileDisplayComponent.prototype, "videoEle", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], FileDisplayComponent.prototype, "removeFile", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], FileDisplayComponent.prototype, "disabled", void 0);
...
var FileComponent = /** @class */ (function () {
    ...
    FileComponent.prototype.removeSubmitFile = function (data) {
